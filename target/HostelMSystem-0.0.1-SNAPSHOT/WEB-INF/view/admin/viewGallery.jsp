							...
							<div class="col-12">
								<div class="card">
									<div class="card-header">
										<h4 style="font-family:cursive;font-size: 30px;color: blue;;margin-left:43%">Gallery</h4>
									</div>
									<div class="card-body">
										<div class="table-responsive">
											...
											<table class="table table-striped table-hover"
												...
												<tbody>
												<f:forEach items="${gallerylist}" var="i" varStatus="j">
													<tr>
														
														<td>${j.count}</td>
														<%-- <td>${i.id}</td> --%>
														<td>${i.galleryType}</td>
														<td><a href="${i.s3Link}" target="_blank"><img alt="Not Found" src="${i.s3Link}"
														                    style="height: 150px;width: 150px" >
														              </a></td>
														<td><a href="deletePhoto?id=${i.id}">delete</a></td>
													</tr>
												</f:forEach>
												</tbody>
											</table>
