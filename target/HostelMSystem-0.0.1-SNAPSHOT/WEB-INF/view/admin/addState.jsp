...
<body>
	...
	<div id="app">
		<div class="main-wrapper main-wrapper-1">
			...
			<!-- Main Content -->
			<s:form action="insertState" modelAttribute="statevo" method="post">
								...
								<div class="card">
									<form class="needs-validation" novalidate="">
										<div class="card-header">
											<h4 style="font-family:cursive;  ;font-size: 30px;color:blue;margin-left:43%">Add State</h4>
										</div>
										<div class="card-body">
											<div class="form-group">
												<s:hidden path="id"/>
												<label>State Name</label> <s:input path="stateName"
													class="form-control" required=""/>
												<div class="invalid-feedback">What's your name?</div>
											</div>
											<div class="form-group mb-0">
												<label>State Discription</label>
												<s:textarea class="form-control" required="" path="stateDescription"></s:textarea>
