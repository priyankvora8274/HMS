...
<body>
	...
	<div class="container profile profile-view"
		style="margin: auto; padding: auto; padding-bottom: 53px;">
		 ...
		 <s:form action="updateProfile" modelAttribute="signinVO" method="post" autocomplete="on">
		 <s:hidden path="id"/>
					...
					<div class="form-row">
						<div class="col-sm-12 col-md-6">
							<div class="form-group">
								...
								<s:input class="form-control" path="firstName" id="fn" 
						...
						<div class="col-sm-12 col-md-6">
							<div class="form-group">
								...
								<s:input class="form-control" path="lastName" id="ln" 
									required="" disabled="true"></s:input>
							</div>
						</div>
					</div>
	...
	<script>
        ...
        bootstrapValidate('#password1','matches:#password:Password should match.')
    </script>
